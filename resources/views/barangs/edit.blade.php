                    ...
                    <div class="card-body">
                        <form action="{{route('barangs.update', $barang->id)}}" method="POST">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-md-6">
                                    <input type="buying_price" id="buying_price" class="form-control" name="buying_price"  required>
                            ...
                            <div class="form-group row mt-3">
                            <label for="product_type" class="col-md-4 col-form-label text-right">product_type</label>
                            <div class="col-md-6">
